...
urlpatterns = patterns('object_permissions_m2m.views.groups',
...
urlpatterns += patterns('object_permissions_m2m.views.permissions',
...
urlpatterns += patterns('object_permissions_m2m.views.widgets',
